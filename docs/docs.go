...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth.ResendOTPreq"
                        }
                    },
                    {
                        "type": "string",
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/auth.ErrorRes400"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                        "schema": {
                            "$ref": "#/definitions/auth.ErrorRes500"
                        }
                    }
                }
            }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/auth.SignInRes"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth.VerifyOTPreq"
                        }
                    },
                    {
                        "type": "string",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bodymetrics.UpsertBodyMetricRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/session.UpdateSessionReq"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/auth.GoogleSignInReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/auth.GoogleSignInRes"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "bodymetrics.UpsertBodyMetricRequest": {
            "type": "object",
            "required": [
                "age",
                "gender",
        ...
        "session.CreateSessionRequest": {
            ...
            "properties": {
                ...
                "startTime": {
                    "type": "string",
                    "example": "2026-06-11T08:00:00Z"
                }
            }
        },
        "session.UpdateSessionReq": {
            "type": "object",
            "properties": {
                "endTime": {
                    "type": "string",
                    "example": "2026-06-11T09:15:00Z"
                },
                "name": {
                    "type": "string",
                    "example": "Morning Push (Heavy)"
                },
                "notes": {
                    "type": "string",
                    "example": "New PR on bench"
                },
                "startTime": {
                    "type": "string",
                    "example": "2026-06-11T08:00:00Z"
